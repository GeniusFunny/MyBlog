var app = (function(){
	var baseUrl = "http://blog.helloyzy.cn";
	var showArticleBaseUrl = baseUrl + "/articels/";
	var teamUrl = baseUrl + "/team";
	var commentUrl = baseUrl + "/coment";
	var pageurl = baseUrl + "/articles?page=";
	var tagUrl = baseUrl + "/tags";
